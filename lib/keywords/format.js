...
const properties = [
  {name: 'formatMinimum', schema: {only: true, valid: {types: ['string']}}, data: {valid: formatMinimumDataValid}},
  {name: 'formatExclusiveMinimum', schema: {only: true, valid: {types: ['string', 'boolean']}}, data: {valid: formatExclusiveMinimumDataValid}},
  {name: 'formatMaximum', schema: {only: true, valid: {types: ['string'],}}, data: {valid: formatMaximumDataValid}},
  {name: 'formatExclusiveMaximum', schema: {only: true, valid: {types: ['string', 'boolean']}}, data: {valid: formatExclusiveMaximumDataValid}},
