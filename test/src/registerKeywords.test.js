...
const corrector = require('../../src/index');
describe('corrector.Schema.registerKeywords 【注册关键字】测试', function () {
  describe('registerKeywords 输出异常', function () {
    it('registerKeywords 传参错误会异常', function () {
      const reg = corrector.Schema.registerKeywords;
...
describe('corrector.Schema.getRegisterKeywordsInfo 【注册关键字】测试', function () {
  it('getRegisterKeywordsInfo 获取到注册的def信息', function () {
    const get = corrector.Schema.getRegisterKeywordsInfo;
